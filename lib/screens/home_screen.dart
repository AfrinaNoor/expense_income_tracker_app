...
import 'categories_screen.dart'; // New screen for categories
...
import 'savings_screen.dart'; // New screen for savings
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<bool> _onWillPop() async {
    // Intercept the back button press to exit the app
    return (await showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        false; // If user presses 'No', prevent app exit
  }
          ...
          child: Container(
            ...
            child: ListView(
              ...
              children: <Widget>[
                ...
                _buildDrawerItem(context, 'Add Expense', Icons.add, primaryTextColor, AddExpenseScreen()),
                _buildDrawerItem(context, 'Add Income', Icons.add_circle, primaryTextColor, AddIncomeScreen()),
                _buildDrawerItem(context, 'Budgeting', Icons.account_balance_wallet, primaryTextColor, BudgetingScreen()),
                _buildDrawerItem(context, 'Categories', Icons.category, primaryTextColor, CategoriesScreen()),
                _buildDrawerItem(context, 'Reports', Icons.bar_chart, primaryTextColor, ReportsScreen()),
                _buildDrawerItem(context, 'Settings', Icons.settings, primaryTextColor, SettingsScreen()),
                _buildDrawerItem(context, 'Savings', Icons.savings, primaryTextColor, SavingsScreen()),
                _buildDrawerItem(context, 'Transaction History', Icons.history, primaryTextColor, TransactionHistoryScreen()),
              ],
            ),
          ),
        ),
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    _buildQuickActionCard(context, 'Add Expense', Icons.add, Colors.pink.shade400, AddExpenseScreen(), primaryTextColor),
                    _buildQuickActionCard(context, 'Add Income', Icons.add_circle, Colors.green.shade400, AddIncomeScreen(), primaryTextColor),
                  ],
                ),
                SizedBox(height: 30),
                Text(
                ...
                SizedBox(height: 20),
                _buildSummaryCard('Total Expenses', '\$${expenseModel.totalExpenses.toStringAsFixed(2)}', Icons.monetization_on, Colors.red.shade400, primaryTextColor),
                SizedBox(height: 10),
                _buildSummaryCard('Total Income', '\$${expenseModel.totalIncome.toStringAsFixed(2)}', Icons.attach_money, Colors.green.shade400, primaryTextColor),
                SizedBox(height: 10),
                _buildSummaryCard('Remaining Balance', '\$${expenseModel.remainingBalance.toStringAsFixed(2)}', Icons.savings, Colors.yellowAccent.shade400, primaryTextColor),
              ],
            ),
          ),
        ),
